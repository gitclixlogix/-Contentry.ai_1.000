            ...
            <VStack align="start" spacing={3}>
              <HStack justify="space-between" w="100%">
                ...
                <Badge colorScheme="brand" fontSize="md" px={3} py={1}>
                  <HStack spacing={1}>
                    <FaUsers />
                    <Text>{countryDetails[selectedCountry].total} Users</Text>
                  </HStack>
                </Badge>
              </HStack>
              ...
              <StatGroup w="100%" gap={4}>
                <Stat>
                  ...
                  <Text fontSize="xs" color="gray.500">
                    {((countryDetails[selectedCountry].male / countryDetails[selectedCountry].total) * 100).toFixed(1)}%
                  </Text>
                </Stat>
                ...
                <Stat>
                  ...
                  <Text fontSize="xs" color="gray.500">
                    {((countryDetails[selectedCountry].female / countryDetails[selectedCountry].total) * 100).toFixed(1)}%
                  </Text>
                </Stat>
                ...
                {countryDetails[selectedCountry].other > 0 && (
                  <Stat>
                    ...
                    <Text fontSize="xs" color="gray.500">
                      {((countryDetails[selectedCountry].other / countryDetails[selectedCountry].total) * 100).toFixed(1)}%
                    </Text>
                  </Stat>
                )}
              </StatGroup>
