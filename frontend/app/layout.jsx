...
import '@/styles/rtl.css'; // RTL language support
import AppWrappers from './AppWrappers';
import '@/i18n/config';
import { isRTL, getUserLanguage } from '@/i18n/config';
    ...
    <html lang={currentLang} dir={direction} suppressHydrationWarning>
      <body id={'root'} suppressHydrationWarning>
        <AppWrappers>
          ...
          {pathname?.includes('register') || pathname?.includes('sign-in') || pathname?.includes('/contentry/') || pathname?.includes('/onboarding') || pathname?.includes('/superadmin/') ? (
            children
          ) : (
            <Box>
